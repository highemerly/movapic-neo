  ...
  return (
    <div className="space-y-4 text-sm text-muted-foreground">
      ...
      <section>
        ...
        <p>
          投稿を忘れた日があっても、同じ月の後日に1日2枚以上投稿し、カレンダーの「編集」で埋める日を選ぶと、2枚目の投稿でその日を&ldquo;穴埋め&rdquo;できます。穴埋めした日は投稿した日と同じく皆勤賞に数えます。
        </p>
        <ul className="mt-1.5 list-disc space-y-1 pl-5">
          <li>1日ぶんの穴埋めに、穴埋めポイントを1pt消費します</li>
          <li>穴埋めに使える投稿は1日1枚までです</li>
          <li>埋められるのは、穴埋めに使う投稿の日より前の日だけです（未来の日や月末日は埋められません）</li>
          <li>

        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              SHAMEZO（以下「本サービス」）をご利用いただくにあたり、以下の利用規約に同意したうえでご利用ください。
            </p>

            <div className="bg-muted rounded-lg p-4">
              <p className="font-medium mb-3">重要なルール</p>
              <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2">
                <li>みんなで楽しく使いましょう。</li>
                <li>悪意を持って意図的にサーバーに負荷をかける行為はやめてください。</li>
                <li>禁止される投稿（法または道徳に反する投稿のこと）はやめてください。</li>
              </ul>
            </div>
            ...
            <div className="bg-muted rounded-lg p-4">
              ...
              <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2">
                ...
                <li>管理人または他のユーザーまたは第三者の知的財産権・肖像権・プライバシー・名誉その他の権利または利益を侵害する投稿</li>
                <li>管理人または他のユーザーまたは第三者への嫌がらせを目的とした投稿</li>
                <li>人種・国籍・信条・性別・社会的身分・門地等による差別を目的とした投稿</li>
                <li>その他、管理人が不適切と判断する投稿</li>
              </ul>
            </div>
            ...
            <div className="bg-muted rounded-lg p-4">
              ...
              <p className="text-sm text-muted-foreground">
                利用規約に逸脱した利用が認められる場合、管理人は投稿の削除やアカウントの停止など必要な処置をとることがあります。
              </p>
            </div>
            ...
            <div className="bg-muted rounded-lg p-4">
              ...
              <p className="text-sm text-muted-foreground">
                本サービスは現状有姿（AS-IS）で提供されます。サービスの継続性・可用性・法律上の瑕疵がないことを、明示的にも暗黙的にも保証しません。また、ユーザーの投稿内容については、投稿したユーザー本人が責任を負うものとします。
              </p>
            </div>

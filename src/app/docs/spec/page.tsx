/**
 * 技術仕様（/docs/spec）: システム構成・画像処理・入力制限などの詳細。
 *
 * もとは /docs に直接書かれていたが、/docs をリンク集（ドキュメントセンター）に
 * 変えたため本文だけをこちらへ移した。
 */
    ...
    <>
      ...
      <PageContainer>
        ...
        <div className="flex items-baseline gap-2 mb-6">
          <h1 className="text-lg font-semibold">技術仕様</h1>
        ...
        <div className="mb-8">
          <div className="space-y-4">
            ...
            <SpecSection id="perfect-month">
              ...
              <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                <li>
                  投稿できなかった日は、その日より後に1日2枚以上投稿し、カレンダーの「編集」で埋める日を選ぶと、2枚目の投稿で穴埋めできます
                </li>
                <li>穴埋めには「穴埋めポイント」を1日につき1pt使います。穴埋めに使える投稿は1日1枚までです</li>
                <li>穴埋めは自動では行われません（穴埋めする日と写真はご自身で選びます）</li>
                <li>埋められるのは、穴埋めに使う投稿の日より前の日だけです（未来の日付は埋められません）</li>
                <li>
                  締め切り（翌月10日 23:59）までに投稿していれば、翌月の投稿も前月の穴埋めに使えます。月末の日もこれで埋められます
                </li>
                <li>穴埋めに使える投稿は1日1枚までで、これは月をまたいでも同じです（翌月◯日の投稿を前月の穴埋めに使うと、その日は翌月の穴埋めには使えません）</li>
                <li>
